...
import echonest.v4.*;
import echonest.v4.CatalogItem;
 ...
 * @author plamere
 */
public class GeneralCatalog extends echonest.v4.Catalog {
    ...
    public List<echonest.v4.CatalogItem> read(int start, int resultCount, String[] buckets)
        ...
        List<echonest.v4.CatalogItem> itemList = new ArrayList<echonest.v4.CatalogItem>();
     ...
     * @throws echonest.v4.EchoNestException
     */
    public List<echonest.v4.CatalogItem> read(int start, int resultCount)
            throws EchoNestException {
     ...
     * @throws echonest.v4.EchoNestException
     */
    public List<echonest.v4.CatalogItem> read(String[] buckets) throws EchoNestException {
