...
import echonest.v4.Track.AnalysisStatus;
import echonest.v4.util.Commander;
import echonest.v4.util.MQuery;
import echonest.v4.util.Utilities;
import java.io.File;
...
public class EchoNestAPI {
    ...
    private echonest.v4.Params stdParams = new echonest.v4.Params();
     ...
     * @throws echonest.v4.EchoNestException
     */
    public echonest.v4.Artist newArtistByID(String id) throws EchoNestException {
        return new echonest.v4.Artist(this, id, false);
    }
     ...
     * @throws echonest.v4.EchoNestException
     */
    public echonest.v4.Artist newArtistByName(String name) throws EchoNestException {
        return new echonest.v4.Artist(this, name, true);
    }
    ...
    public List<echonest.v4.Artist> getSimilarArtists(echonest.v4.Params p) throws EchoNestException {
        List<echonest.v4.Artist> artistResults = new ArrayList<echonest.v4.Artist>();
        ...
        for (int i = 0; i < artistList.size(); i++) {
            ...
            echonest.v4.Artist artist = new echonest.v4.Artist(this, (Map) artistList.get(i));
     ...
     */
    @SuppressWarnings("unchecked")
    public List<echonest.v4.Artist> searchArtists(echonest.v4.Params p) throws EchoNestException {
        List<echonest.v4.Artist> artistResults = new ArrayList<echonest.v4.Artist>();
     ...
     */
    @SuppressWarnings("unchecked")
    public List<echonest.v4.Artist> suggestArtists(echonest.v4.Params p) throws EchoNestException {
        List<echonest.v4.Artist> artistResults = new ArrayList<echonest.v4.Artist>();
     ...
     * @throws echonest.v4.EchoNestException
     */
    public List<echonest.v4.Artist> suggestArtists(String name) throws EchoNestException {
     ...
     */
    @SuppressWarnings("unchecked")
    public List<echonest.v4.Term> getTopTerms(int count) throws EchoNestException {
        ...
        for (int i = 0; i < termList.size(); i++) {
            ...
            echonest.v4.Term term = new echonest.v4.Term(tname, frequency, frequency);
            terms.add(term);
        }
        return terms;
    }
     ...
     * @throws echonest.v4.EchoNestException
     */
    public List<echonest.v4.Artist> searchArtists(String name) throws EchoNestException {
        echonest.v4.Params p = new echonest.v4.Params();
        p.add("name", name);
     ...
     * @throws echonest.v4.EchoNestException
     */
    public List<echonest.v4.Artist> searchArtists(String name, int count)
     ...
     * @throws echonest.v4.EchoNestException
     */
    public List<echonest.v4.Artist> topHotArtists(int count) throws EchoNestException {
        ArtistParams p = new ArtistParams();
        p.setResults(count);
     ...
     * @throws echonest.v4.EchoNestException
     */
    public List<echonest.v4.Artist> topHotArtists(int start, int count)
            throws EchoNestException {
        ArtistParams p = new ArtistParams();
        p.setResults(count);
        p.setStart(start);
     ...
     */
    @SuppressWarnings("unchecked")
    public List<echonest.v4.Artist> topHotArtists(echonest.v4.Params p) throws EchoNestException {
        List<echonest.v4.Artist> artistResults = new ArrayList<echonest.v4.Artist>();
        Map results = cmd.sendCommand("artist/top_hottt", p);
        Map response = (Map) results.get("response");
        List artistList = (List) response.get("artists");
        for (int i = 0; i < artistList.size(); i++) {
            echonest.v4.Artist artist = new Artist(this, (Map) artistList.get(i));
            artistResults.add(artist);
        }
        return artistResults;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public List<echonest.v4.Song> searchSongs(echonest.v4.Params p) throws EchoNestException {
        ...
        for (int i = 0; i < songList.size(); i++) {
            echonest.v4.Song song = new echonest.v4.Song(this, (Map) songList.get(i));
     ...
     */
    @SuppressWarnings("unchecked")
    public List<echonest.v4.Song> similarSongs(echonest.v4.Params p) throws EchoNestException {
        List<echonest.v4.Song> songResults = new ArrayList<echonest.v4.Song>();
     ...
     */
    @SuppressWarnings("unchecked")
    public List<echonest.v4.Song> identifySongs(echonest.v4.Params p) throws EchoNestException {
        List<echonest.v4.Song> songResults = new ArrayList<echonest.v4.Song>();
     ...
     */
    @SuppressWarnings("unchecked")
    public List<echonest.v4.Song> getSongs(echonest.v4.Params p) throws EchoNestException {
        List<echonest.v4.Song> songResults = new ArrayList<echonest.v4.Song>();
     ...
     */
    @SuppressWarnings("unchecked")
    public echonest.v4.Track uploadTrack(URL trackUrl, boolean wait)
            throws EchoNestException {
        ...
        try {
            ...
            echonest.v4.Track track = new echonest.v4.Track(this, trackData);
            return track;
        } finally {
            cmd.setTimeout(tmo);
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public echonest.v4.Track uploadTrack(File audioFile)
            throws EchoNestException, IOException {

        echonest.v4.Track track = getKnownTrack(audioFile);
        if (track != null) {
            return track;
        }
        ...
        try {
            ...
            Map response = (Map) results.get("response");
            Map trackData = (Map) response.get("track");
            track = new echonest.v4.Track(this, trackData);
            return track;
        } finally {
            cmd.setTimeout(tmo);
        }
     ...
     */
    public echonest.v4.Track getKnownTrack(String md5) throws EchoNestException {
        try {
            echonest.v4.Track track = newTrackByMD5(md5);
            AnalysisStatus status = track.getStatus();
     ...
     */
    public echonest.v4.Track getKnownTrack(File file) throws IOException, EchoNestException {
     ...
     * @return a new track
     */
    public echonest.v4.Track newTrackByID(String id) throws EchoNestException {
        return echonest.v4.Track.createTrack(this, id);
    }
     ...
     * @return a new track
     */
    public echonest.v4.Track newTrackByMD5(String md5) throws EchoNestException {
     ...
     */
    @SuppressWarnings("unchecked")
    public echonest.v4.Playlist createBasicPlaylist(echonest.v4.Params p) throws EchoNestException {
        List<echonest.v4.Song> songResults = new ArrayList<echonest.v4.Song>();
        ...
        echonest.v4.Playlist playlist = new echonest.v4.Playlist(songResults);
        return playlist;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public echonest.v4.Playlist createStaticPlaylist(echonest.v4.Params p) throws EchoNestException {
        List<echonest.v4.Song> songResults = new ArrayList<echonest.v4.Song>();
        Map results = cmd.sendCommand("playlist/static", p);
        Map response = (Map) results.get("response");
        List songList = (List) response.get("songs");
        for (int i = 0; i < songList.size(); i++) {
            echonest.v4.Song song = new Song(this, (Map) songList.get(i));
            songResults.add(song);
        }
        echonest.v4.Playlist playlist = new Playlist(songResults);
        return playlist;
    }
     ...
     * @throws echonest.v4.EchoNestException
     */
    public DynamicPlaylistSession createDynamicPlaylist(echonest.v4.Params p) throws EchoNestException {
