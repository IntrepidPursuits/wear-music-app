 ...
 * @author plamere
 */
public class BasicPlaylistParams extends echonest.v4.Params {

    public enum PlaylistType {

        ARTIST_RADIO, SONG_RADIO, GENRE_RADIO
    }
    ...
    /**
     * Sets whether or not to limit results to any of the given rosetta id
     * spaces
     *
