...
public class DynamicPlaylistSteerParams extends echonest.v4.Params {
     ...
     */
    public void addDescription(echonest.v4.EchoNestAPI.DescriptionType type, String term) {
     ...
     * @param boost the boost
     */
    public void addDescription(echonest.v4.EchoNestAPI.DescriptionType type, String term, float boost) {
     ...
     */
    public void banDescription(echonest.v4.EchoNestAPI.DescriptionType type, String term) {
     ...
     */
    public void addSongType(echonest.v4.Song.SongType type, Song.SongTypeFlag flag) {
